...
class Motor:
    ...
    def __init__(self, in1_pin, in2_pin, pwm_pin):
        ...
        """
        self.pinIn1 = machine.Pin(
            in1_pin, machine.Pin.OUT, machine.Pin.PULL_DOWN)
        self.pinIn2 = machine.Pin(
            in2_pin, machine.Pin.OUT, machine.Pin.PULL_DOWN)
    ...
    def short_break(self):
        """
        Performs a "short break" operation on the motor driver that causes the motor to have a rapid stop with resistance.
        """
        self.pinIn1.high()
        self.pinIn2.high()
...
class Motors:
    ...
    def stop_hard(self):
        """
        Does a hard stop on both motors causing them to have resistance to turning and not keep spinning.
        """
        self.left.short_break()
        self.right.short_break()
